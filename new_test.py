...
hidden4 = Dense(128, activation='relu')(droout3)
droout4 = Dropout(0.3)(hidden4)

hidden5 = Dense(64, activation='relu')(droout4)
droout5 = Dropout(0.3)(hidden5)

output = Dense(1, activation='sigmoid')(droout5)
...
# fit network
history = model.fit(Xtrain, ytrain, validation_data=(Xtest, ytest), epochs=30,shuffle=True, verbose=2)
