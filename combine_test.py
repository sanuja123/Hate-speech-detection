...
ytrain = array([0 for _ in range(2890)] + [1 for _ in range(3455)])
...
conv1 = Conv1D(32, kernel_size=8, activation='relu')(embedding)
pool1 = MaxPooling1D(pool_size=(2))(conv1)

conv2 = Conv1D(32, kernel_size=8, activation='relu')(pool1)
...
hidden3 = Dense(256, activation='relu')(droout2)
droout3 = Dropout(0.3)(hidden3)

output = Dense(1, activation='sigmoid')(droout3)
...
# fit network
history = model.fit(Xtrain, ytrain,epochs=3,shuffle=True, verbose=2,validation_split=0.3)
#history = model.fit(Xtrain, ytrain, validation_data=(Xtest, ytest), epochs=50,shuffle=True, verbose=2)
# evaluate
